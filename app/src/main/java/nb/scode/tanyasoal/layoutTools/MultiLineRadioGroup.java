package nb.scode.tanyasoal.layoutTools;

/**
 * Created by User on 1/13/2017.
 * Credits to https://github.com/jevonbeck/AbstractMachine/blob/jevon_dev/app/src/main/java/org/ricts/abstractmachine/ui/utils/MultiLineRadioGroup.java
 */
...
public class MultiLineRadioGroup extends RadioGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for(int x=0; x < count; ++x) {
            ...
            button.layout(dims.left+5, dims.top+5, dims.right, dims.bottom); //edited by myself
        }
    }
